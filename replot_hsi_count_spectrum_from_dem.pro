PRO replot_hsi_count_spectrum_from_dem,epstein=epstein,ps=ps,type=type,chisq_results=chisq_results,combobest=combobest,emfactor=emfactor
...
xyouts,0.75,0.8,textoidl('\chi^2_{hsi} = ' + num2str(chi_label,length=4)),/norm,charsize=1.5
